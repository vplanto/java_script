...
### JSON, серіалізація та аналітика в браузері

*Лекція 5 і Воркшоп 6 — один зв'язний блок: від формату даних до збереження та експорту.*
...
*На занятті — фокус на HTTP і реальному `fetch`. Модель OSI скорочено: детальніше — у самостійному опрацюванні.*

16. \[Самостійно\] [Лекція 6: Архітектура Інтернету. Модель OSI, TCP/IP та DNS](06_networking_osi.md)

### HTTP і практика зовнішнього API

*Єдиний практичний блок: анатомія запиту та робота з мережею в коді.*
...
### Захист SPA: загрози та автентифікація

*Лекція 8 і Воркшоп 8 проходяться разом як один блок — від типових атак на веб до захисту даних і автентифікації в SPA.*
...
### AI й імовірнісні моделі (фінальна практика перед курсовим)

*Окремий обов'язковий практичний етап перед імплементацією курсового. Для математичного треку — найважливіший воркшоп: матриці ймовірностей, ланцюги Маркова.*
