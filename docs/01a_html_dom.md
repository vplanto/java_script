---
title: "Лекція 01a: HTML, DOM та Стандарти (частина 1)"
type: lecture
module: 1
prerequisites:
  - "00_manifesto"
...
* **Результат:** WHATWG [1] перемогла. Зараз HTML не має версій (6, 7, 8). Це **Rolling Release** — стандарт оновлюється постійно. Браузери (Chrome, Safari, Firefox) імплементують саме специфікацію WHATWG, а не W3C.

[1]: sources.md#1-html-living-standard-whatwg
