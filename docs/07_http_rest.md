---
title: "Лекція 7: HTTP/S та REST. Анатомія запиту"
type: lecture
module: 4
prerequisites:
  - "06_networking_osi"
...
Семантика HTTP — **[5] RFC 9110** ([реєстр джерел](sources.md)).
...
Браузерний API `fetch()` визначений у **[6] Fetch Standard** ([реєстр джерел](sources.md)).
